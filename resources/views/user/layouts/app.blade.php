...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Exam -->
            {{-- <li class="nav-item {{ request()->is('exam') ? 'active' : '' }}">
            ...
            <li class="nav-item {{ $courseActive || $lessonActive || $examActive ? 'active' : '' }}">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages"
                    aria-expanded="{{ $courseLessonExpanded ? 'true' : 'false' }}" aria-controls="collapsePages">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Exam</span>
                </a>
                <div id="collapsePages" class="collapse {{ $courseLessonExpanded }}" aria-labelledby="headingPages"
